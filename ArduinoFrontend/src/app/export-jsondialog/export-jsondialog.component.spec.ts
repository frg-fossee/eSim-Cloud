...
describe('ExportJSONDialogComponent', () => {
    ...
    it('should return falsey as workspace is not empty', () => {
        component.ngOnInit();
        window['scope'] = { "id": 1620892078891, "canvas": { "x": 0, "y": 0, "scale": 1 }, "project": { "name": "Untitled", "description": "", "created_at": 1620892078891 }, "Resistor": [{ "x": 483, "y": 209, "tx": 68, "ty": 100, "id": 1620892071196, "data": { "value": 1000, "tolerance": 10 } }] }
