...
// Component search via backend API
export const SEARCH_COMPONENTS_LOADING = 'SEARCH_COMPONENTS_LOADING'
export const SEARCH_COMPONENTS_SUCCESS = 'SEARCH_COMPONENTS_SUCCESS'
export const SEARCH_COMPONENTS_ERROR = 'SEARCH_COMPONENTS_ERROR'
