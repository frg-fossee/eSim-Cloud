...
export default function ClipBoardFunct(graph) {
	...
	// shows a text area when control/cmd is pressed to handle native clipboard actions
	...
	// Takes the xml from the diagram/selected components and then puts in textarea 
	...
	//Merges xml into existing graphs and layers	
