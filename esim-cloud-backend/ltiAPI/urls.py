...
urlpatterns = [
    ...
    path('build/arduino', views.ArduinoLTIBuildApp.as_view(), name="create-arduino-lti"),
    url(r'^update/$', views.LTIUpdateAPP.as_view(), name="create-lti"),
    path('update_arduino/', views.ArduinoLTIUpdateAPP.as_view(), name="create-lti"),
    path('<uuid:save_id>/config.xml/', views.LTIConfigView.as_view(),
         name="config"),
    path('auth/<uuid:save_id>/', views.LTIAuthView.as_view(), name="auth"),
    path('arduino/auth/<uuid:save_id>/', views.ArduinoLTIAuthView.as_view(), name="arduino-auth"),
    path('submit/', views.LTIPostGrade.as_view(), name="submit"),
    path('arduino/submit/', views.ArduinoLTIPostGrade.as_view(), name="submit"),
    ...
    path('save/arduinodata/<uuid:save_id>/<int:lti_id>', views.ArduinoLTISimulationDataView.as_view())
]
