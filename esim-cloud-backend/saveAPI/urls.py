...
urlpatterns = [
    ...
    path('save/<uuid:save_id>/sharing/<str:sharing>/<str:version>',
    ...
    path("save/versions/<str:version>/<uuid:save_id>",
         saveAPI_views.GetStateSpecificVersion.as_view(), name="getSpecificVersion")
