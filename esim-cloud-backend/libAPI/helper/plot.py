...
STROKE_COLOR = "black"
PIN_NAME_COLOR = "black"
PIN_NUMBER_COLOR = "black"
...
def drawCircle(d,x,y,r,fill="red",pen=5):
...
def drawPin(d,pinName,pinNumber,x1,y1,pin_name_offset,length=0,orientation='R',pen=5,text_size=50):
    ...
    if(orientation=="R"):
        ...
        # x = x1
        d.append(draw.Text(pinNumber,text_size, x,y, center=0.6, fill=PIN_NUMBER_COLOR))
        if pinName != "~":
            d.append(draw.Text(pinName,text_size,x1+length+pin_name_offset,y1,center=0.6,fill=PIN_NAME_COLOR))
        ...
        d.append(draw.Text(pinNumber,text_size, x,y, center=0.6, fill=PIN_NUMBER_COLOR))
        if pinName != "~":
            d.append(draw.Text(pinName,text_size,x1,y1+length+pin_name_offset,center=0.6,fill=PIN_NAME_COLOR))
